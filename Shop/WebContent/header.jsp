<%@page import="objects.Category, models.CategoryDB"%>
...
<body>
	...
	<%
		CategoryDB cate = new CategoryDB();
	%>
	<!--header-->
	<div class="header">
			...
			<div class="h_menu4">
				...
				<ul class="nav">
					...
					<li ><a href="#" >Category</a>
						<ul class="drop">
							<%
								for(Category c: cate.getListCategory())
								{
						...
						<li><a href="product.jsp" >Components</a></li>						  				 
						<li><a href="product.jsp" >Software</a></li>
						<li><a href="product.jsp" >Phones & PDAs </a></li>
						<li><a href="product.jsp" >Cameras</a></li>
