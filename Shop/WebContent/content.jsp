<%@page import="models.ProductDB, objects.Product"%>
	...
	<div class="container">
			<div class="content">
				<div class="content-top">
					...
					<%
						for(Product product : productDB.getListProduct())
						{
					...
					%>
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.jsp?productId=<%= product.getProductId() %>"><img  src="<%= product.getProductImage() %>" alt="" /></a>	
								<div class="top-content">
									<h5><a href="single.jsp?productId=<%= product.getProductId() %>"><%=product.getProductName() %></a></h5>
									<div class="white">
										<a href="single.jsp?productId=<%= product.getProductId() %>" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 ">ADD TO CART</a>
										<p class="dollar"><span class="in-dollar">$</span><span><%=product.getProductPrice() %></span><span>0</span></p>
